      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.Main}>
          ...
          <View style={[styles.caixaMateria2, isExpanded2 && styles.caixaMateria2Expandida]}>
            ...
            <Image source={require('D:/Repositorios Git Hub/App-Para-Alunos-e-Professores/assets/IMG/ImgLampada.png')} style={[styles.ImgLampada]} />
          ...
          <View style={[styles.caixaMateria1, isExpanded3 && styles.caixaMateria1Expandida]}>
            ...
            <Image source={require('D:/Repositorios Git Hub/App-Para-Alunos-e-Professores/assets/IMG/globo.png')} style={[styles.ImgLivro]} />
          ...
          <View style={[styles.caixaMateria2, isExpanded4 && styles.caixaMateria2Expandida]}>
            ...
            <Image source={require('D:/Repositorios Git Hub/App-Para-Alunos-e-Professores/assets/IMG/roma.png')} style={[styles.ImgLampada]} />
